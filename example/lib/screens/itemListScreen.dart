        ...
        child: Column(
          children: <Widget>[
            Padding(
              ...
              child: Image.asset("items/fyp.png"),
            ),
            SizedBox(height: 20,),
            Text('AR in Shopping', style: TextStyle(fontSize: 48, color: Colors.white, fontFamily: "Nunito", fontWeight: FontWeight.bold,),),
            SizedBox(height: 10,),
            Padding(
              padding: const EdgeInsets.all(10.0),
              child: Text("An augmented reality mobile application showing how to improve the online shopping experience.", style: TextStyle(fontSize: 20, color: Colors.white, fontFamily: "Nunito"),),
            ),
            Expanded(
                child: Padding(
                            ...
                            child: Row(
                              children: <Widget> [
                                ...
                                Expanded(
                                    child: Column(
                                      children: <Widget>[
                                        Text(items[index].name, style: TextStyle(fontSize: 16, color: Colors.black, fontFamily: "Nunito", fontWeight: FontWeight.bold),),
                                        Text(items[index].detail, style: TextStyle(fontSize: 10, color: Colors.black87, fontFamily: "Nunito"),),
                                      ],
                                    ),
                                ),
                                Container(
                                  width: 60,
                                  child: Text(items[index].price.toString(), style: TextStyle(fontSize: 14, color: Colors.red, fontFamily: "Nunito"),),
                                )
                              ],
                            ),
                          );
